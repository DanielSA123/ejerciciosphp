...
<body>
    ...
    <nav>
      ...
      -->
        ...
        <?php else : ?>
        <a href="index.php?ctl=iniciarSesion">Iniciar Sesion</a> |
        <?php endif; ?>
        <div class="float float-right d-inline-flex mt-2">
            ...
            if (isset($_SESSION['cesta'])) {
                ...
                echo "<input type='text' disabled class='form-control mr-2 bg-transparent text-black' value='$cantidad' size='2px'>";
            } else {
                echo "<input type='text' disabled class='form-control mr-2 bg-transparent text-black' value='0' size='2px'>";
            }

            ?>
            <i class="fas fa-user mr-3 fa-2x"></i>
            <input type="text" size='10px' value="<?php echo isset($_SESSION['nombre']) ? $_SESSION['nombre'] : "" ?>"
                class="form-control
      mr-2 bg-transparent text-black" disabled>
            <?php if (isset($_SESSION['nombre'])) : ?>
            <a href="index.php?ctl=cerrarSesion" class="btn btn-warning mr-2">Salir</a>
            <?php endif; ?>
        </div>
        <hr>
    </nav>
